<template>
  <div>
    <div class="page">
      <div class="header">
        <div class="container">
          <p class="title">Privacy Policy for tushers care</p>
        </div>
      </div>
      ...
      <div class="translations-content-container">
        <div class="container">
          <div class="tab-content translations-content-item en visible" id="en">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  device, named tushers care
                </p>
              </li>
              <li>
                <p>
                  <strong>Company</strong> (referred to as either "the Company",
                  "We", "Us" or "Our" in this Agreement) refers to tushers care,
                  Tushers Care,Faridpur,Dhaka,bangladesh.
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>By phone number: 01867417227</li>
            </ul>
          </div>
        </div>
      </div>
